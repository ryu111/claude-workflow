---
name: resume
description: 接手並繼續執行 OpenSpec 工作（單步模式）。觸發詞：接手、resume、繼續、恢復執行
...
| 指令 | 模式 | 說明 |
|------|------|------|
| `/resume` | 單步 | 執行一個任務後停止，適合需要人工確認的情況 |
